# `fa_game_info` `0x18644`: positive state-8 bit-6/bit-15/bit-21 composition

The measured positive-threshold fighter fields `0x208140` (state bit 8 plus
fighter flag bits 6, 15 and 21) were recovered at the `0x18644` child. The
...
python3 decomp/i960/tools/validate_game_info_state4.py \
  ...
  --state 8 --include-bit8 --extra-bit 6 --extra-bit 15 --extra-bit 21 \
