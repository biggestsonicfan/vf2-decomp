# `fa_game_info` `0x18644`: positive state-8 bit-6/bit-14/bit-16/bit-21 composition

The measured positive-threshold fighter fields `0x214140` (state bit 8 plus
fighter flag bits 6, 14, 16 and 21) were recovered at the `0x18644` child.
