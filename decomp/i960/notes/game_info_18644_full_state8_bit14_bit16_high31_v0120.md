# `fa_game_info` `0x1645c`: full state-8 bit-14/bit-16/high-bit-31 composition

The full dispatcher was measured for field mask `0x80214000`, the adjacent
high-bit-31 composition after the state-8 child selector/low-field bits are
removed. The native dispatcher admission was checked for fighter-0-only,
fighter-1-only and bilateral fighter-record distributions, countdown `0/1`,
mode-byte bit 6 clear/set, and thresholds `0`, `1` and `2`.
