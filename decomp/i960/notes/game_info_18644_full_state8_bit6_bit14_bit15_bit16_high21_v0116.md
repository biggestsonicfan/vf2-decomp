# `fa_game_info` `0x1645c`: full state-8 all-high bit-21 composition

The full dispatcher was measured for field mask `0x0021c000`, corresponding
to the already-proven child composition `0x21c140` after the state-8 child
