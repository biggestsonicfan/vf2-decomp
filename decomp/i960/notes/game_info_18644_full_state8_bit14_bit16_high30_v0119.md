# `fa_game_info` `0x1645c`: full state-8 bit-14/bit-16/high-bit-30 composition

The full dispatcher was measured for field mask `0x40214000`, corresponding
to the already-proven child composition `0x40214140` after the state-8 child
