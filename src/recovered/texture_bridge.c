...
static vf2_status execute_game_meter_component(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    uint32_t selector,
    uint32_t structure,
...
static vf2_status execute_game_meter_update(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_frame_geometry_gate(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_video_register_compose(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_video_input_latch_write(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_player_update_gate(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_video_layer_commit(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_input_sequence_gate(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    uint32_t entry,
...
static vf2_status execute_input_ring_poll(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_tile_runtime_gate(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_game_input_update(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_game_state_update(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
{
    ...
    if (status != VF2_OK || (input_flags & (UINT32_C(1) << 3u)) == 0u) {
        return status == VF2_OK ? VF2_ERROR_UNSUPPORTED : status;
    }
    cpu->registers[VF2_I960_G0_REGISTER + 9u] = base;
...
static vf2_status execute_tile_controller_update(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static void finish_recovered_control_block(
    vf2_i960_cpu *cpu,
...
static vf2_status execute_frame_timer_prefix(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_save_prefix(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_buffer_gate(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_input_ring(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_restore_prefix(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_frame_timer_suffix(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_texture_status_tail(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_player_layer(
...
static vf2_status execute_interrupt_game_input(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_interrupt_game_state(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_interrupt_tile_sync(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_main_post_timer(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
    vf2_hybrid_bridge_report a={0},b={0},d={0}; uint64_t i=cpu->executed_instructions,c=cpu->procedure_calls,r=cpu->procedure_returns;
...
static vf2_status execute_main_clear_prefix(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_main_final_cluster(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_main_geometry_prefix(
    vf2_model2a *machine, vf2_i960_cpu *cpu, vf2_hybrid_bridge_report *report)
{
...
static vf2_status execute_main_texture_orchestrator_call(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_main_frame_timer_call(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
...
static vf2_status execute_interrupt_initial_cluster(
    vf2_model2a *machine,
    vf2_i960_cpu *cpu,
    vf2_hybrid_bridge_report *report
)
