    ...
    }
    {
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            ...
            (combined_positive_bit6_flags == UINT32_C(0x0000c140) ||
             combined_positive_bit6_flags == UINT32_C(0x0000c144) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c140) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c144))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x0000c142) ||
             combined_positive_bit6_flags == UINT32_C(0x0000c146) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c142) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c146))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x0000c150) ||
             combined_positive_bit6_flags == UINT32_C(0x0000c154) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c150) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c154))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x0000c152) ||
             combined_positive_bit6_flags == UINT32_C(0x0000c156) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c152) ||
             combined_positive_bit6_flags == UINT32_C(0x0001c156))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            ...
            (combined_positive_bit6_flags == UINT32_C(0x00008140) ||
             combined_positive_bit6_flags == UINT32_C(0x00008144))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00008142) ||
             combined_positive_bit6_flags == UINT32_C(0x00008146))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00008150) ||
             combined_positive_bit6_flags == UINT32_C(0x00008154))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00008152) ||
             combined_positive_bit6_flags == UINT32_C(0x00008156))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            ...
            (combined_positive_bit6_flags == UINT32_C(0x00010140) ||
             combined_positive_bit6_flags == UINT32_C(0x00010144))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00010142) ||
             combined_positive_bit6_flags == UINT32_C(0x00010146))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00010150) ||
             combined_positive_bit6_flags == UINT32_C(0x00010154))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00010152) ||
             combined_positive_bit6_flags == UINT32_C(0x00010156))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            ...
            (combined_positive_bit6_flags == UINT32_C(0x00018140) ||
             combined_positive_bit6_flags == UINT32_C(0x00018144))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00018142) ||
             combined_positive_bit6_flags == UINT32_C(0x00018146))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00018150) ||
             combined_positive_bit6_flags == UINT32_C(0x00018154))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
        ...
        if (fighter0_state == 8u && fighter1_state == 8u &&
            measured_matrix_distribution &&
            (int32_t)shared_fighter_threshold >= 0 &&
            (combined_positive_bit6_flags == UINT32_C(0x00018152) ||
             combined_positive_bit6_flags == UINT32_C(0x00018156))) {
            const bool fighter0_only =
                fighter0_state_flags == combined_positive_bit6_flags &&
                fighter1_state_flags == 0u;
            const bool bilateral =
